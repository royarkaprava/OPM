#' @title The function to fit OPM algorithm for variable selection under two data-types Adaptive elastic net in Step I and OPM in step 2
...
#' @return fit.AENOPM returns a list of errors (prediction and estimation in that order) and the coefficients \cr
